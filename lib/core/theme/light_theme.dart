...
const Color secondTextColor = Color(0xFF353535);
...
const Color primBackgroundColor = Color(0xFFFAFAFA);
const Color secondBackgroundColor = Color(0xFFFFFFFF);
const Color inputPrimBackgroundColor = Color(0xFFFAFAFA);
const Color inputSecondBackgroundColor = Color(0xFFF3F4F5);
const Color inputTextColor = Color(0xFF7D7D7D);
const Color inputHintColor = Color(0xFFADB5BD);
...
ThemeData lightTheme() {
  ...
  return ThemeData(
    ...
    dialogBackgroundColor: inactiveTextColor,
    brightness: brightness,
    /**appBarTheme: const AppBarTheme(
      backgroundColor: secondBackgroundColor,
    ),*/
    textTheme: TextTheme(
        displayLarge: TextStyle(color: primaryDarkColor,fontSize: 30.sp, height: sizeHeight),
        displayMedium: TextStyle(color: secondTextColor, fontSize: 14.sp, height: sizeHeight),
        displaySmall: TextStyle(color: secondTextColor, fontSize: 14.sp, height: sizeHeight),
        headlineMedium: TextStyle(color: inputTextColor, fontSize: 14.sp,height: sizeHeight),
        headlineSmall: TextStyle(color: inputHintColor, fontSize: 12.sp,  height: sizeHeight),
        titleLarge: TextStyle(color: primaryDarkColor, fontSize: 18.sp,height: sizeHeight),
        titleMedium: TextStyle(color: secondTextColor, fontSize: 14.sp,  height: sizeHeight2),
        titleSmall: TextStyle(color: primaryDarkColor,  height: sizeHeight2),
        bodyLarge: TextStyle(color: primBackgroundColor,fontSize: 16.sp, height: sizeHeight2),
